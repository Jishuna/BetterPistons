...
import me.jishuna.betterpistons.nms.v1_20_R1.visitor.TickNodeVisitor;
import net.minecraft.core.BlockPos;
import net.minecraft.world.level.Level;
import net.minecraft.world.level.block.piston.PistonMovingBlockEntity;
import net.minecraft.world.level.block.state.BlockState;

public class PistonBlockEntityClassWriter {
    private static final Type FINAL_TICK_TYPE = Type.getMethodType(Type.VOID_TYPE);
    private static final Type TICK_TYPE = Type.getMethodType(Type.VOID_TYPE, Type.getType(Level.class), Type.getType(BlockPos.class), Type.getType(BlockState.class), Type.getType(PistonMovingBlockEntity.class));
    private static final Multimap<Integer, Supplier<NodeVisitor>> VISITORS = ArrayListMultimap.create();

    static {
        VISITORS.put(INVOKEVIRTUAL, TickNodeVisitor::new);
    }

    private final ClassReader reader;
    private final ClassWriter writer;

    public PistonBlockEntityClassWriter(byte[] contents) {
    ...
    public byte[] rewrite() {
        ...
        for (MethodNode methodNode : classNode.methods) {
            ...
            if ((type.equals(TICK_TYPE)) || (type.equals(FINAL_TICK_TYPE) && !name.contains("init"))) {
